    ...
    init: (client) => {
        ...
        sendDiscordNotification = (message) => {
            ...
            if (client.isReady()) {
                ...
                console.log('Discord client belum siap, tidak bisa mengirim notifikasi.');
            }
        };
        ...
        const connect = () => {
            ...
            mcBot.on('spawn', () => {
                ...
                isBotReady = true; // Set status bot siap
            ...
            mcBot.on('end', reason => {
                isBotReady = false; // Reset status bot tidak siap
...
async function handleDiscordCommand(command, args, player) {
    if (!mcBot || !isBotReady) {
        return sendDiscordNotification("Bot Minecraft belum terhubung atau belum siap!");
    }
