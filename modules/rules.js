...
module.exports = {
    name: 'rules',
    description: 'Menampilkan rules, punishment, dan sistem warn dengan tombol',
    execute: async (message) => {
        ...
        collector.on('collect', async (i) => {
            if (i.customId === 'rules_btn') {
                ...
                await i.reply({ embeds: [allowedEmbed], ephemeral: true });
            } 
            else if (i.customId === 'punishment_btn') {
                ...
                await i.reply({ embeds: [notAllowedEmbed], ephemeral: true });
            }
            else if (i.customId === 'warn_btn') {
